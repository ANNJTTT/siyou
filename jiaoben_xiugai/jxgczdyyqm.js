...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `http://jd.nglabs.net/api/v2/jd/jxfactory/read/${randomCount}/`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    $.shareCodesArr = ['0lp3mgTALDIkMOB4QnL-Dg==','kmLMl77u8V3ktCxprtBnFQ==','G3bwGGtAsyhBuzkflt0s0g==','0lp3mgTALDIkMOB4QnL-Dg==','kmLMl77u8V3ktCxprtBnFQ==',,'G3bwGGtAsyhBuzkflt0s0g==','0lp3mgTALDIkMOB4QnL-Dg==','kmLMl77u8V3ktCxprtBnFQ=='];
    if ($.isNode()) {
